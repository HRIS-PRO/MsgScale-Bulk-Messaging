    ...
    <header className="h-16 flex items-center justify-between px-6 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-background-dark z-30 shrink-0 theme-transition">
      ...
      <div className="flex items-center gap-2 ml-6">
        ...
        <div className="relative">
          ...
          >
            <span className="text-xs font-semibold text-slate-900 dark:text-white">Workspace A</span>
          ...
          {isWorkspaceOpen && (
            <div className="absolute right-0 mt-2 w-56 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-2xl z-50 overflow-hidden ring-1 ring-black ring-opacity-5 animate-[fadeIn_0.2s_ease-out]">
              <div className="py-1">
                ...
                <button className="flex items-center justify-between w-full px-4 py-2.5 text-sm text-slate-900 dark:text-slate-200 bg-slate-50 dark:bg-slate-800/50 text-left">
                  <span className="font-bold italic">Workspace A</span>
                  <span className="material-symbols-outlined text-green-500 text-sm font-black">check</span>
                </button>
                <button className="flex items-center w-full px-4 py-2.5 text-sm text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-colors text-left font-medium">
                  Marketing Team B
                </button>
                <div className="border-t border-slate-200 dark:border-slate-800 my-1"></div>
                <button className="flex items-center gap-2 px-4 py-2.5 text-sm text-primary hover:bg-primary/5 dark:hover:bg-primary/10 transition-colors w-full text-left font-bold">
